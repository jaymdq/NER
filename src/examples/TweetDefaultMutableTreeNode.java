...
public class TweetDefaultMutableTreeNode extends DefaultMutableTreeNode {
	...
	public TweetDefaultMutableTreeNode( String text ) {
		this.text = text;
		this.setOpenIcon(new ImageIcon("./src/examples/twitter_minus_16x16.png"));
		this.setClosedIcon(new ImageIcon("./src/examples/twitter_plus_16_16.png"));
		this.setTweetIcon(new ImageIcon("./src/examples/twitter_16x16.png"));
	}
